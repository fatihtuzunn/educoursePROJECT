<template>
  <div class="auth-wrapper auth-v2">
    <b-row class="auth-inner m-0">
      ...
      <!-- Left Text-->
      <b-col lg="8" class="d-none d-lg-flex align-items-center p-5 flex-column">
        <h3 class="mt-5 text-center">Welcome to <span class="brand-text text-primary">educourse. 👋</span> 
            <br> New generation video education platform.
          </h3>
        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5 mt-5">
...
export default {
  ...
  methods: { 
    validationForm() {
      this.$refs.loginValidation.validate().then(success => {
        if (success) {
          ...
          axios.post(`${this.$hostname}/api/user/authenticate`, {
    ...
    'Access-Control-Allow-Headers': '*',
            ...
            component: ToastificationContent,
            props: {
              title: 'Hatalı şifre veya email girdiniz.',
              icon: 'BellIcon',
              variant: 'danger',
            },
          });
